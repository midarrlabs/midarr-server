defmodule MediaServerWeb.SeriesControllerTest do
  ...
  test "it should have all", %{conn: conn, user: user} do
    ...
    assert conn.resp_body ===
             "{\"items\":[{\"background\":\"/api/images?series=1&type=background\",\"overview\":\"An object in the sky spreads radiation over North America. Fearing terrorism, U.S. Homeland Security agents are dispatched to investigate and contain the damage. What they discover will have implications for the entire world.\",\"poster\":\"/api/images?series=1&type=poster\",\"seasonCount\":1,\"stream\":\"/api/stream?series=1\",\"title\":\"Pioneer One\",\"year\":2010}],\"next_page\":\"/api/series?page=2\",\"prev_page\":\"/api/series?page=0\",\"total\":1}"
  end
