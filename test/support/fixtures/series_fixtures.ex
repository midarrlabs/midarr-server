defmodule MediaServer.SeriesFixtures do
  ...
  def setup() do
    integration = %{
      base_url: Application.fetch_env!(:media_server, :series_base_url),
      api_key: Application.fetch_env!(:media_server, :series_api_key)
    }

    add_series_root(integration)
    add_series(integration)
  end
end
