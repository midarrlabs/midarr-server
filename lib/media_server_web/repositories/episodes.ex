defmodule MediaServerWeb.Repositories.Episodes do
  ...
  def get_all(series_id, season_number) do
    MediaServer.SeriesIndex.get("episode?seriesId=#{series_id}&seasonNumber=#{season_number}&includeImages=true")
  end

  def get_all(series_id) do
    MediaServer.SeriesIndex.get("episode?seriesId=#{series_id}&includeImages=true")
  end

  def get_episode(id) do
    MediaServer.SeriesIndex.get("episode/#{id}")
  end

  def get_episode_path(id) do
    episode = MediaServer.SeriesIndex.get("episode/#{id}")
