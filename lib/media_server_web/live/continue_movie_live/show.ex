defmodule MediaServerWeb.ContinueMovieLive.Show do
  ...
  def handle_params(%{"id" => id}, _url, socket) do
...

    {
      ...
      |> assign(:movie, movie)
      |> assign(:continue, socket.assigns.current_user.movie_continues |> Enum.filter(fn item -> item.movie_id == movie["id"] end) |> List.first())
    }
  end
